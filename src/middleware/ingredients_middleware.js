...
const { INVALID_INGREDIENT_NAME, NOT_A_NUMERIC, DUPLICATED_NAME, INVALID_ID,
        MUST_CONTAINS_AN_ARRAY, INVALID_MEASURE_TYPE, CANT_FIND_INGREDIENT,
        INVALID_ARRAY, LAYER_BIGGER_ZERO } = require("../models/utils/Ingredient-ErrorMSGs")
...
const processIngredientDelete = async (req,res) => {
    ...
    try {
        ...
        if ( result ) await Ingredient.update({is_acive: false},{where: {id}})
